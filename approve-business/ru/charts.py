...
title = "<b>Одобрение ведения бизнеса с представителями следующих национальностей</b><br>Кавказский барометр, Грузия и Армения 2019 и 2009"

chart1 = (
    pd.read_csv("charts.csv")
...
title = "<b>Одобрение того, что женщины вашей национальности вступают в брак с представителями следующих национальностей</b><br>Кавказский барометр, Грузия и Армения (2019 и 2009)"
